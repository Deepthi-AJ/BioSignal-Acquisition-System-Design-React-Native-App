...
//w/l = 2/1 in design initially
// |-Vth| is taken for pmos, so not making any further changes in the equation for Id
//w/l = 3*(2/1) = 6/1 (using inverter design) vgs = 1V and vds = 1.8V by 180 nm CMOS technology node specifications in design initially


//for ramp input : updateTerminalVoltages()

class PMOS extends React.Component{
    constructor(){
    super();
    this.state={
      // vgs: 1,
  ...
  render(){
    return(
      ...
      <View style={styles.container}>
        ...
        <TouchableOpacity style={styles.button} onPress={this.pmosBehavioralModel()}>
  PMOS
        </TouchableOpacity>
